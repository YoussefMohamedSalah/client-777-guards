    ...
    <div className="2xl:container 2xl:mx-auto lg:py-16 lg:px-20 md:py-12 md:px-6 py-9 px-4">
      ...
      <div className="grid sm:grid-cols-3 grid-cols-2 sm:gap-8 gap-4">
        <div>
          ...
          <p className="font-normal text-base leading-6 text-gray-600 mt-6">
            An Egyptian company compliant with Law No. 151 of the year 1981, based on internationally accredited courses
            to achieve the highest levels of security and stability in serving individuals and establishments under the
            supervision of specialized professionals in security and safety management. With experience exceeding 22
            years.
          </p>
        </div>
        <div>
          ...
          <p className="font-normal text-base leading-6 text-gray-600 mt-6">
            Electronic Surveillance (Cameras) and Early Fire Alarm Systems.
          </p>
          <p className="font-normal text-base leading-6 text-gray-600 mt-3">X-ray Detection Devices.</p>
          <p className="font-normal text-base leading-6 text-gray-600 mt-3">
            Indoor Access Control Systems, Perimeter Protection Devices, and various integrated security solutions.
          </p>
          <p className="font-normal text-base leading-6 text-gray-600 mt-3">
            The company comprises a team of competent engineers and skilled technicians experienced in various security
            technologies.
          </p>
        </div>
        <div className="sm:block hidden">
          ...
          <p className="font-normal text-base leading-6 text-gray-600 mt-3">
            Comprehensive Security and Management Services for Public Institutions, Private Enterprises, Malls,
            Hospitals, Clubs, Tourist Villages, Banks, and Hotels, both interior and exterior, including towers and
            warehouses.
          </p>
          <p className="font-normal text-base leading-6 text-gray-600 mt-3">
            Dedicated Security Services for High-profile Individuals, Celebrities, and Business Leaders.
          </p>
        </div>
      </div>
