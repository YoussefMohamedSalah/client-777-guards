const SampleArrowLeft: React.FC<React.SVGAttributes<{}>> = ({ ...rest }) => {
  return (
    <svg width="24" height="24" viewBox="0 0 24 24" fill="#323129" xmlns="http://www.w3.org/2000/svg" {...rest}>
...
export default SampleArrowLeft;
